...
- LFSR113 pseudo random number generator based on L'Ecuyer, 1999, Tables of maximally equidistributed combined LFSR generators.
- SCRAMBLED_SOBOL32 and SCRAMBLED_SOBOL64 quasi random number generators added.
### Changed
